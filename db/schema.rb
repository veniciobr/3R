...
ActiveRecord::Schema.define(version: 20141117123357) do
  ...
  create_table "users_1", force: true do |t|
    t.string   "email",                                 null: false
    t.string   "name",                                  null: false
    t.string   "password",                              null: false
    t.string   "enable",        limit: 1, default: "S", null: false
    t.string   "administrator", limit: 1, default: "N", null: false
    t.datetime "created_at",                            null: false
    t.datetime "updated_at",                            null: false
  end

  add_index "users_1", ["email"], name: "email", unique: true, using: :btree
